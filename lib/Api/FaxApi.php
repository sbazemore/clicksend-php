...
class FaxApi
{
     ...
     * @return string
     */
    public function faxReceiptsGet($q, $page = '1', $limit = '10')
    {
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function faxReceiptsGetWithHttpInfo($q, $page = '1', $limit = '10')
    {
        $returnType = 'string';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function faxReceiptsGetAsync($q, $page = '1', $limit = '10')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function faxReceiptsGetAsyncWithHttpInfo($q, $page = '1', $limit = '10')
    {
        $returnType = 'string';
        $request = $this->faxReceiptsGetRequest($q, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function faxReceiptsGetRequest($q, $page = '1', $limit = '10')
    {
        // verify the required parameter 'q' is set
        if ($q === null || (is_array($q) && count($q) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $q when calling faxReceiptsGet'
            );
        }
        if ($page !== null && $page < 1) {
