...
class FaxApi
{
     ...
     *
     * @param  \Swagger\Client\clicksend.model\FaxMessageCollection $fax_message FaxMessageCollection model (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     ...
     * @return string
     */
    public function faxReceiptsGet()
    {
        list($response) = $this->faxReceiptsGetWithHttpInfo();
        return $response;
    }
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function faxReceiptsGetWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->faxReceiptsGetRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function faxReceiptsGetAsync()
    {
        return $this->faxReceiptsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function faxReceiptsGetAsyncWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->faxReceiptsGetRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function faxReceiptsGetRequest()
    {
