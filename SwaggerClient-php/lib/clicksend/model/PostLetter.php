...
class PostLetter implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'file_url' => 'string',
        'recipients' => '\Swagger\Client\clicksend.model\PostRecipient[]',
        'template_used' => 'int',
        'duplex' => 'int',
        'colour' => 'int',
        'source' => 'string'
     ...
     * Gets recipients
     *
     * @return \Swagger\Client\clicksend.model\PostRecipient[]
     */
     ...
     * Sets recipients
     *
     * @param \Swagger\Client\clicksend.model\PostRecipient[] $recipients Array of PostRecipient models
     *
     * @return $this
     */
