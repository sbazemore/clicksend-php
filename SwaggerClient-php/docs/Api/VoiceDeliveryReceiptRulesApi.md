# Swagger\Client\VoiceDeliveryReceiptRulesApi
...
$apiInstance = new Swagger\Client\Api\VoiceDeliveryReceiptRulesApi(
...
$delivery_receipt_rule = new \Swagger\Client\clicksend.model\DeliveryReceiptRule(); // \Swagger\Client\clicksend.model\DeliveryReceiptRule | voice delivery receipt rule model
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **delivery_receipt_rule** | [**\Swagger\Client\clicksend.model\DeliveryReceiptRule**](../Model/DeliveryReceiptRule.md)| voice delivery receipt rule model |
