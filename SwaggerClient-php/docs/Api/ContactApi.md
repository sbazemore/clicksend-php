...
$contact_id = 56; // int | Contact ID
$contact = new \Swagger\Client\Model\Contact(); // \Swagger\Client\Model\Contact | Contact model
 ...
 **contact_id** | **int**| Contact ID |
 **contact** | [**\Swagger\Client\Model\Contact**](../Model/Contact.md)| Contact model |
