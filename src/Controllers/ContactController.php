...
class ContactController {
                ...
                $listId) 
    {
        ...
        $queryBuilder = $queryBuilder.'/lists/{{list_id}}/contacts';
                ...
                $contactId) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/lists/{{list_id}}/contacts/{{contact_id}}';
                ...
                $optOutListId) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/lists/{{list_id}}/remove-opted-out-contacts/{{opt_out_list_id}}';
